...
from functions.ext.pyndlib.pynd import segutils as su

# the neuron folder should be on the path
from functions.ext.neuron import plot as nrn_plt
from functions.ext.neuron import utils as nrn_utils
