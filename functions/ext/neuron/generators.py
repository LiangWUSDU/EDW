...
# local packages
from functions.ext.pyndlib.pynd import ndutils as nd
from functions.ext.pytools import patchlib as pl
from functions.ext.pytools import timer as timer
...
from functions.ext.neuron import dataproc as nrn_proc
...
def _relabel(vol_data, labels, forcecheck=False):
    ...
    new_vol_data = np.zeros(np.shape(vol_data),dtype= np.float32)
